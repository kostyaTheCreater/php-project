...
<html>
    ...
    <body>
      ...
      <div class="jumbotron container mt-5">
        <h1>Edit conference data</h1>
        <form class="container mt-5" id="formElem" action='/controllers/update_controller.php' method='post'>
            
            <input type="text" class="form-control" id='numOfConference' name="id" placeholder="Title" hidden>
            ...
            <div id="map"></div>
            <input type="address" class="form-control" name='address' id="address" hidden>
            </div>
            ...
            <button id='send' type="submit" class="btn btn-primary mb-3">Save</button>
        </form>
          <div class="d-flex justify-content-end mt-4 mr-5">
              <button id='deleteButton' type="button" class="btn btn-danger">Delete</button>
          </div>
          <div class="d-flex justify-content-end mt-4 mr-5">
              <button id='backButton' type="button" class="btn btn-dark">Back</button>
          </div>
        </div>
      ...
      <script>
        ...
        formElem.onsubmit = function(e){
          if(!title.value || !meetingdate.value){
            e.preventDefault();
            if(!title.value) title.classList.add('invalid');
            if(!meetingdate.value) meetingdate.classList.add('invalid');
          }
        }
      ...
      <script
        ...
        defer
      ></script>
      <script src="../components/edmap.js"></script>
